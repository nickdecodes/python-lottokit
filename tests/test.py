...
if __name__ == '__main__':
    ...
    # d.download_data()
    # d.fetch_data()
    d.predict(next_period=2025049, next_weekday=1, predict_type='llm', window_size=15)
    # d.predict(next_period=2025049, next_weekday=1, predict_type='analyze', window_size=15)
